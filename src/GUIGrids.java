...
public class GUIGrids extends JPanel{
	...
	public void paintComponent(Graphics g) {
		...
		g.drawImage((new ImageIcon("src/resources/sea.png")).getImage(), 0, 0, CELL_SIZE * 10, CELL_SIZE * 10, this);
		...
		for (int i = 0; i < N_ROWS; i++) {
			...
			for (int j = 0; j < N_COLS; j++) {
				...
				switch (cell) {
				case SHIPSUNK:
					img = (new ImageIcon("src/resources/11.png")).getImage();
					break;
				case SHIPHIT:
					img = (new ImageIcon("src/resources/9.png")).getImage();
					break;
				case WATER:
					img = (new ImageIcon("src/resources/10.png")).getImage();
					break;
				case MISS:
					img = (new ImageIcon("src/resources/01.png")).getImage();
					break;
				case SHIPINTACT:
					if (showShips) {
						img = (new ImageIcon("src/resources/6.png")).getImage();
					} else {
						img = (new ImageIcon("src/resources/10.png")).getImage();
					}
					break;
				case SELECTED_WATER:
					img = (new ImageIcon("src/resources/1.png")).getImage();
					break;
