...
public class GUIMainPage extends JPanel{
	...
	public GUIMainPage(GUIPanel panel) {
		...
		title = new JLabel();
		title.setIcon(new ImageIcon("src/resources/BattleShip.png"));
		...
		mode4.setToolTipText("If turns are unluckily missed in a row, the next shot will be more precision-boosted!");
	...
	//icon for button
	ImageIcon icon = new ImageIcon("src/resources/button.png"); 
